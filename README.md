...
├── Rapport_Arbres_Decision.md      # Rapport détaillé du projet
├── impurete_comparison.png         # Visualisation des mesures d'impureté
...
2. **Implémentation From Scratch** : Coder un arbre de décision sans librairies ML
   - Structure récursive de l'arbre
   - Calcul du gain d'information
   - Prédiction et visualisation

3. **Extensions** : Explorer les méthodes d'ensemble
   - Random Forest
   - Gradient Boosting
...
---
*Projet réalisé dans le cadre du cours de Data Mining / Machine Learning*
